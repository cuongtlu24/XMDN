...
export default function Page() {
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: bg }}>
      ...
      <header className="sticky top-0 z-[100] border-b border-white/10 backdrop-blur bg-[#052c24]/95">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between gap-3">
          <div className="flex items-center gap-4 min-w-0 flex-wrap">
            ...
            <span className="hidden md:inline text-sm md:text-base font-bold text-white/80">
        ...
        <div className="relative rounded-[32px] overflow-hidden border border-white/10 shadow-2xl">
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 md:p-12 max-w-4xl mx-auto">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4">
              <a
                href="#dangky"
                className="flex-1 px-6 py-3 rounded-2xl font-black uppercase tracking-widest shadow-2xl hover:scale-[1.02] transition text-center"
                style={{ background: gold, color: bg }}
              >
                NHẬN BÁO GIÁ
              </a>
              <a
                href="#lienhe"
                className="flex-1 px-6 py-3 rounded-2xl font-black uppercase tracking-widest border border-white/15 hover:bg-white/5 transition text-center"
              >
                LIÊN HỆ
              </a>
            </div>
      ...
      {/* ===== FOOTER ===== */}
      <footer className="border-t border-white/10 py-6 text-center text-white/70 text-sm">
        &copy; {new Date().getFullYear()} {data.name} | {data.document} | {data.address} | {data.phone}
      </footer>
    </div>
  );
}
